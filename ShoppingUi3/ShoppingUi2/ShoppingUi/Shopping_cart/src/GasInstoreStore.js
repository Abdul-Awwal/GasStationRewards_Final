...
export default class GasInstoreStore extends React.Component {
  ...
  getTest=()=>{
      ...
      var value = false;
      var tempResponse = {};
      fetch('http://192.168.254.98:3000/readUsers')
      ...
      fetch('http://192.168.254.98:3000/readPoints')
        .then(response => response.json())
        //.then(users => console.log())
        .then(users => {
          //var x =
  ...
  postTransaction=()=>{
    ...
    postPricePoint=(price, points)=>{
            ...
            fetch('http://192.168.254.98:3000/addTransaction', {
    ...
    getLatestTransactionId=(points)=>{
        ...
        fetch('http://192.168.254.98:3000/readTransactionIds')
          .then(response => response.json())
          //.then(users => console.log())
          .then(users => {
            //var x =
    ...
    postTransactionItems=(transactionId,points)=>{
        ...
        for (let i = 0; i < this.state.cart.length; i++) {
            ...
            if(this.state.cart[i].ItemKey<7){
                ...
                fetch('http://192.168.254.98:3000/addStoreTransaction', {
                    method: 'POST', // Here you're saying that you want to make a POST request. Could be any method, like a GET, for example.
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json',
              ...
              .catch((error) => console.warn(error))
                ...
                console.log(this.state.cart[i].ItemQuantity);
                fetch('http://192.168.254.98:3000/addGasTransaction', {
                    method: 'POST', // Here you're saying that you want to make a POST request. Could be any method, like a GET, for example.
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json',
    ...
    addToTotalPoints=(totalPoints)=>{
      ...
      console.log(this.state.userId);
      fetch('http://192.168.254.98:3000/addToTotalPoints', {
          method: 'POST', // Here you're saying that you want to make a POST request. Could be any method, like a GET, for example.
          headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
